...
})(["require", "exports", "./util", "fast-deep-equal", "json-schema-traverse", "uri-js"], function (require, exports) {
    var _this = this;
    {
        AnySchema, AnySchemaObject;
    }
    from;
    "../types";
    from;
    ...
    function countKeys(schema) {
        ...
        for (var key in schema) {
            ...
            if (typeof schema[key] == "object") {
                util_1.eachItem(schema[key], function (sch) { return (count += countKeys(sch)); });
            }
            if (count === Infinity)
                return Infinity;
        }
    ...
    LocalRefs;
    {
        ...
        traverse(schema, { allKeys: true }, function (sch, jsonPtr, _, parentJsonPtr) {
            ...
            if (typeof sch.$id == "string")
                baseId = addRef.call(_this, sch.$id);
        ...
        unknown;
        void {
            if: function () { }, typeof: anchor == "string" };
        {
