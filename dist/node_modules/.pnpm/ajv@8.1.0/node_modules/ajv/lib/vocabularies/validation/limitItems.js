(function (deps, factory) {
    ...
    var def = {
        ...
        code: function (cxt) {
            ...
            cxt.fail$data((_a = ["", ".length ", " ", ""], _a.raw = ["", ".length ", " ", ""], codegen_1._(_a, data, op, schemaCode)));
            var _a;
        },
    };
    exports.default = def;
